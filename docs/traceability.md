...
| **FR-205** | Conversions that are not fixed — "one bunch of curry leaves" — are supported with an agreed nominal weight, and flagged as approximate. | Should | `apps/catalog/management/commands/import_measures.py`<br>`apps/catalog/models.py` | `apps/catalog/tests/test_imports.py`<br>`apps/knowledge/tests/test_format.py` |
