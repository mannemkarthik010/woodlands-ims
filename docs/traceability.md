...
| **FR-107** | The system flags a shift with no clock-out, or an unusually long one, so the owners can review it. | Should | `apps/labour/services.py`<br>`apps/labour/views.py` | `apps/labour/tests/test_clock.py`<br>`apps/labour/tests/test_pay.py`<br>`apps/labour/tests/test_report.py` |
...
| **FR-113** | Time records cannot be silently deleted, and the history of any edit is retained. | Must | `apps/labour/admin.py`<br>`apps/labour/models.py`<br>`apps/labour/pay.py`<br>`apps/labour/services.py` | `apps/labour/tests/test_clock.py` |
